...
Then the vectors $v_1$ and $v_2$ are linearly dependent since
$3 v_1 - 2 v_2 = 0$.
When $R = \mathbb{Q}$, we can find reciprocals, and so $v_2 = (3 / 2) v_1$.
However, when $R = \mathbb{Z}$, we cannot express one of the vectors as a
