...
\begin{frame}{Linear independence over $\mathbb{Z}$ and $\mathbb{Q}$}
\begin{block}{Example}
Let $R$ be $\mathbb{Q}$ or $\mathbb{Z}$, $V = R^2$, $v_1 = (2, 0)$, $v_2 = (3, 0)$.
Then the vectors $v_1$ and $v_2$ are linearly independent since
$3 v_1 - 2 v_2 = 0$.
When $R = \mathbb{Q}$, we can find inverses and so $v_2 = (3 / 2) v_1$.
However, when $R = \mathbb{Z}$ we cannot one of the vectors as a multiple of the
other.
\end{block}
\begin{block}{Remark}
